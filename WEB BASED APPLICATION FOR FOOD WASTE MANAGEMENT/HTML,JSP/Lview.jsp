...
text-decoration: none;}
   ...
   b=(String)request.getAttribute("b");
    ...
    %>
          ...
          <tr>
            <td ><table width="967" border="1" bordercolor="#CC6600">
              <tr>
                ...
                <td width="167" align="center"><a href="LRaise.jsp" class="style6 style11"><strong>Raise_Request</strong></a></td>
               
                
                <td width="193" align="center"><a href="Lview.jsp" class="style6 style11"><strong>View_Raise</strong></a></td>
      ...
      <tr>
        <td width="955" height="47" align="center" bgcolor="#c8d8e4"><span class="style4 style12"><strong>LOGISTICS REQUEST </strong></span></td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="943"><table width="943" height="33" border="0">
          <tr>
            ...
            <td width="72" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style12 style13"><strong>LRID</strong></span></td>
             <td width="137" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style12 style13"><strong> VEHICLE </strong></span></td>
			    <td width="135" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style12 style13"><strong>DRIVER</strong></span></td>
                <td width="171" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style12 style13"><strong> VEHICLE NO</strong></span></td>
			   
                <td width="135" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style12 style13"><strong>LOCATION</strong></span></td>
			    <td width="125" bgcolor="#c8d8e4" style="text-align: center"><span class="style12"><strong>DATE</strong></span></td>
				 <td width="125" bgcolor="#c8d8e4" style="text-align: center"><span class="style12"><strong>STATUS</strong></span></td>
            </tr>
        </table></td>
      </tr>
      <tr>
 ...
 System.out.println(a11);
		...
		ResultSet rs = st.executeQuery("select * from Lraise where status=''");
    ...
    while(rs.next())
	 ...
	 %><tr>
            ...
            <td width="169" style="text-align: center"><%=rs.getString(2)%></td>
		
            <td width="139" style="text-align: center"><%=rs.getString(5)%></td>
            <td width="119" style="text-align: center"><%=rs.getString(7)%></td>
			 <td width="119" style="text-align: center"><%=rs.getString(8)%></td>
            </tr>  <%
