...
text-decoration: none;}
    ...
    <body bgcolor="#2b6777"><form action="lhelp" method="post"> <%
  ...
  String pr=null,pro=null,pro1=null,pro2=null;
 		try {
          ...
          while (rs1.next()) {
           ...
           %>
                        <tr>
                          <td width="783"><span class="style16"><strong>Request Id:</strong><%=rs1.getString(1)%> </span></td>
                        </tr>
                        <tr>
                          <td><span class="style16"><strong>Issue:</strong><%=rs1.getString(3) %></span></td>
                        </tr>
                        <tr>
                          <td><span class="style16"><strong>Description:</strong><%=rs1.getString(4) %></span></td>
                        </tr>
                        <tr>
                          <td><span class="style16"><strong>Resolution:</strong><%=rs1.getString(5) %></span></td>
                        </tr> <%}
        }
        catch(Exception e)
        {
