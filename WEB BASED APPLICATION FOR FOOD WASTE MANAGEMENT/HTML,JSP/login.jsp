...
text-decoration: none;}
    ...
    <body bgcolor="#2b6777"><FORM action="login" method="post">
     <%
          ...
          <tr>
            <td ><table width="967" border="1" bgcolor="c8d8e4" bordercolor="#CC6600">
              <tr>
                ...
                <td width="173" align="center"><a href="about.jsp" class="style6 style11"><strong>About Us</strong></a></td>
        <td width="237" align="center"><a href="contact.jsp" class="style6 style11"><strong>Contact Us</strong></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td height="356"><table   border="1" align="center" bordercolor="#003366">
                    <tr>
                      <td  height="22" align="center" bgcolor="#c8d8e4"><h4 align="center" class="title style2 style12 style13">LOGIN</h4></td>
                    </tr>
                    <tr>
                      <td height="126" align="center">
                        ...
                        <tr>
                          <td width="128" class="style10 style13"><span class="style12 style17 "><strong>USERNAME<span class="style16">* </span></strong></span></td>
                ...
                &nbsp;&nbsp;&nbsp; </label></td>
                        ...
                        <tr>
                          <td class="style10"><span class="style12 style17 style13"><strong>PASSWORD<span class="style16"> *</span></strong></span></td>
                ...
                &nbsp;&nbsp;&nbsp; </label></td>
                        ...
                        <tr>
                          <td></td>
                          <td ><label><input type="submit" name="Submit" value="SignIn"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="submit" name="Submit2" value="Cancel" />
                          </label></td>
                        </tr>
                      </table>                   </td>
                    </tr><tr>
                      <td width="380" height="16" align="center" ><h4 align="center" class="title style2 style12 style13"><a href="fpwd.jsp" class="style11 ">Change Password </a></h4></td>
                    </tr>
      </table>
