...
.style13 {font-size: 12}
    ...
    <body bgcolor="#2b6777"><form action="Draise" method="post"> <%
  ...
  <tr>
    <td width="958" height="28"><%=msg%></td>
  </tr>
  <tr>
    <td height="275"><table width="589" border="1" align="center" bordercolor="#003366">
      <tr>
        <td width="583" height="30" align="center" bgcolor="#c8d8e4"><h2 class="style50">Raise Request</h2></td>
      </tr>
      <tr>
        <td height="251" align="center"><table width="437" border="0" align="center">
            <tr>
              <td width="152" height="35" ><span class="style18 style15 style14"><strong>Name</strong></span></td>
            ...
            <tr>
              <td height="31" ><span class="style15 style14"><strong>Purpose</strong></span></td>
              <td class="style2"><label>
                <input type="text" id="purpose" name="purpose" style="width:180px" value="" class="displayValue" onKeyPress="return name_val(event);return nospecialcharacters();" onChange="return val_zero('purpose','err_purpose');" onBlur="return txt_empty('purpose','err_purpose','Should Not Be Blank');"/>
                &nbsp;&nbsp;&nbsp;<span id="err_purpose"></span> </label></td>
            </tr>
			

            <tr>
              <td height="31" ><span class="style15 style14"><strong>Location</strong></span></td>
              <td class="style2"><label>
            ...
            <tr>
              <td height="37" class="style10 style6"><span class="style4 style15 style14"><strong>Contact no</strong></span></td>
              <td class="style2"><label>
 ...
 onBlur="return txt_empty('dob','err_dob','Should Not Be Blank');"/>
			...
			<tr>
              <td width="152" height="35" ><span class="style18 style15 style14"><strong>No of Food Pocket </strong></span></td>
              <td width="275" class="style2"><label>
            ...
            <tr>
              ...
              <td class="style2"><input type="submit" name="add" value="Submit"  class="buttons" onClick="return validatePage('name|purpose|pocket|location|contact','err_name|err_purpose|err_pocket|err_location|err_contact','Should Not Be Blank|Should Not Be Blank|Should Not Be Blank|Should Not Be Blank|Should Not Be Blank');"  />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
