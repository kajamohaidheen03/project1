...
text-decoration: none;}
    ...
    <body bgcolor="#2b6777"> <form action="Lverify" method="post">
              <%
   String ok="";
      String ok1="";
   String msg="",msg1="";
      ...
      <tr>
        <td width="943"><table width="943" height="33" border="0">
          <tr>
            ...
            <td width="72" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style12 style13"><strong>SELECT</strong></span></td>
             <td width="137" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style12 style13"><strong> VEHICLE </strong></span></td>
                ...
                <td width="171" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style12 style13"><strong> VEHICLE NAME </strong></span></td>
