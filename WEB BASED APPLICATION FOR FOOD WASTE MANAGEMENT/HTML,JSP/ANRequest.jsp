...
text-decoration: none;}
    ...
    <body bgcolor="#2b6777">
   <form action="Nverify" method="post">
              <%
   String ok="";
      String ok1="";
   String msg="",msg1="";
        ...
        <td width="943"><table width="943" height="33" border="0">
          <tr>
            ...
            <td width="72" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style12 style13"><strong>SELECT</strong></span></td>
             <td width="137" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style12 style13"><strong> NAME</strong></span></td>
			    <td width="135" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style12 style13"><strong>OCCASION</strong></span></td>
                <td width="171" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style12 style13"><strong> LOCATION </strong></span></td>
			   
                <td width="135" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style12 style13"><strong>DATE</strong></span></td>
			    <td width="125" bgcolor="#c8d8e4" style="text-align: center"><span class="style12"><strong>NO OF POCKET </strong></span></td>
            </tr>
        </table></td>
      </tr>
      <tr>
 ...
 System.out.println(a11);
		...
		ResultSet rs = st.executeQuery("select * from Nraise where status=''");
