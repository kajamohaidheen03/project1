...
text-decoration: none;}
   ...
   b=(String)request.getAttribute("b");
    ...
    %>
      ...
      <tr>
        <td width="955" height="47" align="center" bgcolor="#c8d8e4"><span class="style50"><strong>Donor Request</strong></span></td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="943"><table width="943" height="33" border="0">
          <tr>
            ...
            <td width="72" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style6"><strong>DRID</strong></span></td>
             <td width="137" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style6"><strong> NAME</strong></span></td>
			    <td width="135" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style6"><strong>PURPOSE</strong></span></td>
                ...
                <td width="135" bgcolor="#c8d8e4" style="text-align: center"><span class="style4 style6"><strong>DATE</strong></span></td>
			    <td width="125" bgcolor="#c8d8e4" style="text-align: center"><span class="style6"><strong>NO OF POCKET </strong></span></td>
 ...
 System.out.println(a11);
		...
		ResultSet rs = st.executeQuery("select * from Draise ");
