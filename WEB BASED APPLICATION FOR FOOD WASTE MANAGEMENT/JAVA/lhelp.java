 ...
 * @author WINDOWS 10
 */
public class lhelp extends HttpServlet {
        ...
        try {
		      ...
		      Connection con = DriverManager
	                ...
	                if(request.getParameter("add")!=null){
	                    ...
	                    RequestDispatcher rs=request.getRequestDispatcher("LHelp.jsp");
	 	      ...
	 	      int v=   smt.executeUpdate("insert into help values('"+uid+"','"+so.getAttribute("un")+"','"+occasion+"','"+location+"','')");
	 			...
	 			RequestDispatcher requestdispatcher = request.getRequestDispatcher("LHelp.jsp");
