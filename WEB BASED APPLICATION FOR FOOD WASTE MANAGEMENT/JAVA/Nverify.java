 ...
 * @author WINDOWS 10
 */
public class Nverify extends HttpServlet {
        ...
        PrintWriter out = response.getWriter();
         try {
	            ...
	            if (request.getParameter("t2") != null) {
	              ...
	              v2 = st.executeUpdate("update NRaise set status='" + request.getParameter("t2") + "' where NRID='" + b + "'");
	                if (v2 == 1) {
	                    request.setAttribute("ok", "1");
	                    request.setAttribute("msg", " Updated Successfully");
	                    RequestDispatcher rs21 = request.getRequestDispatcher("ANRequest.jsp");
	            	 ...
	            	 String v = null;
		              ...
		              v2 = st.executeUpdate("update NRaise set status='" + request.getParameter("t1") + "' where NRID='" + b + "'");
		                if (v2 == 1) {
		                    request.setAttribute("ok", "1");
		                    request.setAttribute("msg", " Updated Successfully");
		                    RequestDispatcher rs21 = request.getRequestDispatcher("ANRequest.jsp");
