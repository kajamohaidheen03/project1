 ...
 * @author WINDOWS 10
 */
public class nhelp extends HttpServlet {
        ...
        try {
		      ...
		      Connection con = DriverManager
	                ...
	                if(request.getParameter("add")!=null){
	                    ...
	                    RequestDispatcher rs=request.getRequestDispatcher("NHelp.jsp");
	 	      ...
	 	      int v=   smt.executeUpdate("insert into help values('"+uid+"','"+so.getAttribute("un")+"','"+occasion+"','"+location+"','')");
	 			...
	 			RequestDispatcher requestdispatcher = request.getRequestDispatcher("NHelp.jsp");
