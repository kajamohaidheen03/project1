 ...
 * @author WINDOWS 10
 */
public class Hverify extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
	            ...
	            if (request.getParameter("t1") != null) {
	              ...
	              v2 = st.executeUpdate("update help set resolution='" + request.getParameter("a2") + "' where HID='" + b + "'");
	                if (v2 == 1) {
	                    request.setAttribute("ok", "1");
	                    request.setAttribute("msg", " Updated Successfully");
	                    RequestDispatcher rs21 = request.getRequestDispatcher("AHelp.jsp");
