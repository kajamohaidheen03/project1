...
/**@author WINDOWS 10
 */
public class Lverify extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
	            ...
	            if (request.getParameter("t2") != null) {
	              ...
	              v2 = st.executeUpdate("update LRaise set status='" + request.getParameter("t2") + "' where LRID='" + b + "'");
	                if (v2 == 1) {
	                    request.setAttribute("ok", "1");
	                    request.setAttribute("msg", " Updated Successfully");
	                    RequestDispatcher rs21 = request.getRequestDispatcher("ALRequest.jsp");
	            	 ...
	            	 String v = null;
		              ...
		              v2 = st.executeUpdate("update LRaise set status='" + request.getParameter("t1") + "' where LRID='" + b + "'");
		                if (v2 == 1) {
		                    request.setAttribute("ok", "1");
		                    request.setAttribute("msg", " Updated Successfully");
		                    RequestDispatcher rs21 = request.getRequestDispatcher("ALRequest.jsp");
